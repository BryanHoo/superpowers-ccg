---
name: superpowers-ccg-executing-plans
...
**Claude Model Selection:** When dispatching Claude subagents for task execution, use `@coder` for implementation work. Sonnet excels at code writing and is more cost-effective than Opus for execution tasks.
...
3. **► Checkpoint 1 (Task Analysis):** Apply checkpoint logic from `superpowers-ccg-coordinating-multi-model-work/checkpoints.md`:
...
- **REQUIRED SUB-SKILL:** Use superpowers-ccg-finishing-development-branches
...
**Fallback (Fail-Closed):** If external models are not available or time out, STOP and follow `superpowers-ccg-coordinating-multi-model-work/GATE.md` (do not proceed with task completion output).
