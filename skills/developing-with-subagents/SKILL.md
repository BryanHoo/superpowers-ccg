---
name: superpowers-ccg-developing-with-subagents
...
digraph process {
    ...
    "Use superpowers-ccg-finishing-development-branches" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Use superpowers-ccg-finishing-development-branches";
}
```
...
| --------------------- | --------------- | -------------------------------- |
| Implementer           | `@coder` | Low - always use Sonnet for code |
| Spec/Quality Reviewer | Opus (default)  | Low - always use Opus for review |
| Exploration           | `@explore`  | Medium - prefer Haiku, flexible  |

## Collaboration Checkpoints

Apply checkpoint logic from `superpowers-ccg-coordinating-multi-model-work/checkpoints.md` at these stages:
...
- **superpowers-ccg-writing-plans** - Creates the plan this skill executes
- **superpowers-ccg-requesting-code-review** - Code review template for reviewer subagents
- **superpowers-ccg-finishing-development-branches** - Complete development after all tasks
- **superpowers-ccg-coordinating-multi-model-work** - Multi-model routing for task execution

**Subagents should use:**

- **superpowers-ccg-practicing-test-driven-development** - Subagents follow TDD for each task

**Alternative workflow:**

- **superpowers-ccg-executing-plans** - Use for parallel session instead of same-session execution

## Multi-Model Task Dispatch

**Related skill:** superpowers-ccg-coordinating-multi-model-work

At checkpoints, apply semantic routing from `superpowers-ccg-coordinating-multi-model-work/routing-decision.md`:
...
- **Call MCP tool** with English prompts (see `superpowers-ccg-coordinating-multi-model-work/INTEGRATION.md` for templates). Use `@backend` for backend, `@frontend` for frontend, and call both in parallel for CROSS_VALIDATION.

**Full checkpoint logic:** See `superpowers-ccg-coordinating-multi-model-work/checkpoints.md`

**Fallback (Fail-Closed):** If external models are required but unavailable or time out, STOP and follow `superpowers-ccg-coordinating-multi-model-work/GATE.md` (do not proceed with task completion output).
