---
name: superpowers-ccg-writing-skills
...
**REQUIRED BACKGROUND:** You MUST understand superpowers-ccg-practicing-test-driven-development before using this skill.
...
**REQUIRED BACKGROUND:** superpowers-ccg-practicing-test-driven-development explains why this matters.
...
**Model tip:** Use `@coder` for test execution subagents. Sonnet follows instructions well and is cost-effective for repeated testing iterations.
