---
name: superpowers-ccg-using-superpowers
...
If a task would benefit from specialized external models, you MUST use `superpowers-ccg-coordinating-multi-model-work` and follow `superpowers-ccg-coordinating-multi-model-work/GATE.md`. CODEX/GEMINI/CROSS_VALIDATION/CLAUDE are routing labels for MCP tool usage (`@backend`, `@frontend`).
