---
name: superpowers-ccg-dispatching-parallel-agents
...
| Task Type | Model |
|-----------|-------|
| Code fixes, implementations | `@coder` |
| Architecture review | Opus (default) |
| Codebase exploration | `@explore` |

```typescript
// Sonnet for code, Haiku for search, Opus for review
Task("Fix test failures", model: "@coder")
Task("Find deprecated API usages", model: "@explore")
