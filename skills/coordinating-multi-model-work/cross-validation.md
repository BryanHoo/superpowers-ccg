...
Send tasks to both @backend and @frontend simultaneously, each analyzing from their professional perspective.
...
├─────────────────────────────────────────┤
│                                         │
│  Backend Conclusion   Frontend Conclusion│
│      │                 │                │
│      └────────┬────────┘                │
│               │                         │
...
#### Suggested Solution
[Backend's suggested solution]

### Frontend Analysis (@frontend)

#### Analysis Conclusion
[Frontend's main conclusion]
...
| Aspect | Backend View | Frontend View | Arbitration Conclusion |
|--------|-------------|---------------|------------------------|
...
- Dispatch @backend and @frontend in parallel to reduce wait time
- Use parallel dispatch patterns to request both subagents simultaneously
