---
name: superpowers-ccg-debugging-systematically
...
**► Checkpoint 1 (Task Analysis):** Before investigation, apply checkpoint logic from `superpowers-ccg-coordinating-multi-model-work/checkpoints.md`:
...
3. **Check Recent Changes**
   ...
   **Search tip:** When dispatching subagents to search for code patterns or trace data flow, use `@explore` for fast, cost-effective exploration.
...
**► Checkpoint 2 (Mid-Review):** When testing hypothesis, apply checkpoint logic from `superpowers-ccg-coordinating-multi-model-work/checkpoints.md`:
...
1. **Create Failing Test Case**
   ...
   - Use the `superpowers-ccg-practicing-test-driven-development` skill for writing proper failing tests
...
- **superpowers-ccg-practicing-test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **superpowers-ccg-verifying-before-completion** - Verify fix worked before claiming success
- **superpowers-ccg-coordinating-multi-model-work** - For multi-model cross-validation diagnosis

## Multi-Model Cross-Validation

**Related skill:** superpowers-ccg-coordinating-multi-model-work

At checkpoints, apply semantic routing using `superpowers-ccg-coordinating-multi-model-work/routing-decision.md`:
...
See `superpowers-ccg-coordinating-multi-model-work/INTEGRATION.md` for invocation templates.

**Fallback (Fail-Closed):** If Codex MCP / Gemini MCP is unavailable or times out when Routing != CLAUDE, STOP and follow `superpowers-ccg-coordinating-multi-model-work/GATE.md` (do not proceed with a final conclusion).
