---
name: superpowers-ccg-finishing-development-branches
...
**Called by:**
- **superpowers-ccg-developing-with-subagents** (Step 7) - After all tasks complete
- **superpowers-ccg-executing-plans** (Step 5) - After all batches complete

**Pairs with:**
- **superpowers-ccg-using-git-worktrees** - Cleans up worktree created by that skill
